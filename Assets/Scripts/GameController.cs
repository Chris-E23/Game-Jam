...
namespace CorruptElementary
{
    public class GameController : MonoBehaviour
    {
        ...
        [SerializeField] private UnityEvent _onLunchTimeStart;
                    ...
                    case gamestate.recess:
                        if (daystatus == days.friday)
                        {
                            ...
                            if (NPChandler.gameObject.GetComponent<NameGenerator>().ganglist.Count >= 5)
                            {
                                ...
                                interactiontxt.text =
                                    "You've outlasted the bully everyday, now launch your attack on him";
        ...
        public void recesstime()
        {
            ...
            interactionScreen.SetActive(true);
            interactiontxt.text =
                "It's recess time, your bully is going to go after you to steal your money, last the period in order to keep your money.";
            bribebutton.gameObject.SetActive(false);
            cam.gameObject.GetComponent<CamController>().enabled = false;
            player.gameObject.GetComponent<PlayerController>().enabled = false;
            Cursor.lockState = CursorLockMode.None;
